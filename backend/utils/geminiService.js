 ...
 * @returns {Promise<Array<{question: string, answer: string, difficulty:
 * string>>}}
 */
...
* @returns {Promise<Array<{question: string, options: Array, correctAnswer:
string, explanation: string, difficulty: string}}
*/


export const generateQuiz = async (text, numQuestions = 5) => {
  const prompt = `Generate exactly ${
      numQuestions} multiple choice questions from the following text.
