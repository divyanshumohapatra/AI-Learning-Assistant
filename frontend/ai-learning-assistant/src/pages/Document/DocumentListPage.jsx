            ...
            return (
                <div className="flex items-center justify-center min-h-[400px]">
                    <div className="text-center max-w-md">
                        <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-linear-to-br from-slate-100 to-slate-200 shadow-lg shadow-slate-200/60 mb-6">
                            <FileText
                ...
                <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
                    ...
                    <form onSubmit={handleUpload} className="space-y-5" >
                        ...
                        <div className="space-y-2">
                            {/* FIX: typo "tex-slate-700" → "text-slate-700" */}
