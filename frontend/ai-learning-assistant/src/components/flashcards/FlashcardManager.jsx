    ...
    const renderSetList = ()=>{
        ...
        return (
            <div className='space-y-6'>
                {/* Handle with generate button */}
                <div className='flex items-center justify-between'>
                    <div>
                        <h3 className='text-lg font-semibold texxt-slate-900'>
                            Your Flashcard Sets
                        </h3>
                    ...
                    {flashcardSets.map((set)=>(
                        ...
                        >
                            ...
                            <div className='space-y-4'>
                                <div className='inline-flex items-center justify-center w-12 h-12 rounded-xl bg-linar-to-br from-emerald-100 to-teal-100'>
